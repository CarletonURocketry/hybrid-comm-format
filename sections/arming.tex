...
% TODO: this section should contain all the arming states mentioned at the propulsion meeting on Sept 10th.
% THIS DOES NOT INCLUDE the pseudo-arming states enacted by actuating the quick disconnect, igniter, etc. Although those
% will still signal a BAD_PERM error if performed out of order.
